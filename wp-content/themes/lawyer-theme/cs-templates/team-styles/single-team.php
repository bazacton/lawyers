...
<section class="page-section team-detail" style=" padding: 0; "> 
  ...
  <div class="container"> 
	...
	if (have_posts()):
		...
		$social_switch = isset($cs_xmlObject->post_social_sharing) ?  $cs_xmlObject->post_social_sharing : '';
        ...
        <!-- Row -->
            ...
            <figure class="detailpost">
                ...
                <figcaption>
                    ...
                    <?php if(isset($social_switch) and $social_switch == "on" ) { ?>
          ...
          <div id="cs-check-list" class="col-md-6  cs-check-list">
			  <?php
          ...
          <div class="col-md-6 cs-check-list">
              <?php
