                ...
                <div class="input-sec">
                  <div class="select-style">
				    <select name="cs_blog_view[]" class="dropdown">
                      <option value="blog-small" <?php if($cs_blog_view == 'blog-small'){echo 'selected="selected"';}?>><?php _e('Blog Small','Lawyer');?></option>
                      <option value="blog-medium" <?php if($cs_blog_view == 'blog-medium'){echo 'selected="selected"';}?>><?php _e('Blog Medium','Lawyer');?></option>
                      <option value="blog-lrg" <?php if($cs_blog_view == 'blog-lrg'){echo 'selected="selected"';}?>><?php _e('Blog Large','Lawyer');?></option>
                      <option value="blog-masonry" <?php if($cs_blog_view == 'blog-masonry'){echo 'selected="selected"';}?>><?php _e('Blog Masonry','Lawyer');?></option>
                      <option value="blog-grid" <?php if($cs_blog_view == 'blog-grid'){echo 'selected="selected"';}?>><?php _e('Blog Grid','Lawyer');?></option>
                    </select>
                  </div>
                </div>
                <div class="left-info">
                    ...
                    <div class="input-sec">
                      <div class="select-style">
                        <select name="cs_blog_filterable[]" class="dropdown">
                          <option value="yes" <?php if($cs_blog_filterable=="yes")echo "selected";?>><?php _e('Yes','Lawyer'); ?></option>
                          <option value="no" <?php if($cs_blog_filterable=="no")echo "selected";?> ><?php _e('No','Lawyer'); ?></option>
                        </select>
                      </div>
                    </div>
                  </li>
