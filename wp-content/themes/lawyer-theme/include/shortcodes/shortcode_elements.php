        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="slider" data="<?php echo element_size_data_array_index($postslider_element_size) ?>">
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_postslider {{attributes}}]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Post Slider Options', 'Lawyer'); ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <ul class="form-elements noborder">
                            <li class="to-label">
                                <label><?php _e('Slider Header Title', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <div class="input-sec">
                        ...
                        <ul class="form-elements noborder">
                            <li class="to-label">
                                <label><?php _e('Choose Slider Type', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <div class="input-sec">
                                    <div class="select-style">
                                        <select name="cs_slider_type[]" class="dropdown" onchange="cs_toggle_height(this.value, 'cs_slider_height<?php echo esc_attr($name . $cs_counter) ?>')">
                                            <option <?php
                                            if ($cs_slider_type_db == "Post Slider") {
                                                echo "selected";
                                            }
                                            ?> ><?php _e('Post Slider', 'Lawyer'); ?></option>
                                            <option <?php
                                            if ($cs_slider_type_db == "Flex Slider") {
                                                echo "selected";
                                            }
                                            ?> ><?php _e('Flex Slider', 'Lawyer'); ?></option>
                                            <option <?php
                                            if ($cs_slider_type_db == "Custom Slider") {
                                                echo "selected";
                                            }
                                            ?> ><?php _e('Custom Slider', 'Lawyer'); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="form-elements noborder" id="post_slider" style="display:inline">
                            <li class="to-label">
                                <label><?php _e('Choose Post Category', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <div class="input-sec">
                                    <div class="select-style">
                        ...
                        <ul class="form-elements" id="layer_slider" style="display:none" >
                            <li class="to-label">
                                <label><?php _e('Use Short Code', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                            ...
                            <li class="to-field">
                                <p><?php _e('Please enter the Revolution/Other Slider Short Code like [rev_slider name]', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                    </div>
