    ...
    <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="column" data="<?php echo element_size_data_array_index($video_element_size) ?>" >
        ...
        <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_video {{attributes}}]{{content}}[/cs_video]" style="display: none;">
            <div class="cs-heading-area">
                <h5><?php _e('Edit Video Options', 'Lawyer'); ?></h5>
                ...
                <div class="cs-wrapp-clone cs-shortcode-wrapp">
                    ...
                    <ul class="form-elements">
                        ...
                        <li class="to-field">
                            ...
                            <p><?php _e('give the video url here', 'Lawyer'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Width', 'Lawyer'); ?></label>
                        </li>
                        <li class="to-field">
                            <input type="text" name="video_width[]" class="txtfield" value="<?php echo esc_attr($video_width); ?>" />
                            <p><?php _e('Add a width in pix, If you want to override the default', 'Lawyer'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label">
                        ...
                        <li class="to-field">
                            ...
                            <p><?php _e('Provide height in px, if you want to override the default', 'Lawyer'); ?> </p>
                        </li>
                    </ul>
                    <?php
    ...
    function cs_pb_image($die = 0) {
        ...
        <div id="<?php echo cs_allow_special_char($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class); ?> <?php echo cs_allow_special_char($shortcode_view); ?>" item="image" data="<?php echo element_size_data_array_index($image_element_size); ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter) ?> <?php echo cs_allow_special_char($shortcode_element); ?>" id="<?php echo cs_allow_special_char($name . $cs_counter) ?>" data-shortcode-template="[cs_image {{attributes}}]{{content}}[/cs_image]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Image Options', 'Lawyer'); ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Image Style', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select class="image_style" name="image_style[]">
                                    <option <?php
                                    if ($image_style == 'frame-plane') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="frame-plane"><?php _e('Plain', 'Lawyer'); ?></option>
                                    <option <?php
                                    if ($image_style == 'frame-clean') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="frame-clean"><?php _e('Clean', 'Lawyer'); ?></option>
                                    <option <?php
                                    if ($image_style == 'frame-classic') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="frame-classic"><?php _e('Classic', 'Lawyer'); ?></option>
                                    <option <?php
                                    if ($image_style == 'frame-simple') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="frame-simple"><?php _e('Simple', 'Lawyer'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Image Url', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <input id="cs_image_url<?php echo esc_attr($rand_id) ?>" name="cs_image_url[]" type="hidden" class="" value="<?php echo esc_url($cs_image_url); ?>"/>
                                <input name="cs_image_url<?php echo esc_attr($rand_id) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'Lawyer'); ?>"/>
                                <div class="left-info">
                                    <p><?php _e('Browse the image', 'Lawyer'); ?> </p>
                                </div>
                            </li>
                        </ul>
                        <ul class="form-elements">
                                        ...
                                        <div class="dragareamain" style="padding-bottom:0px;">
                                            <ul id="gal-sortable">
                                                <li class="ui-state-default" id="">
                                                    <div class="thumb-secs"> <img src="<?php echo cs_allow_special_char($cs_image_url); ?>"  id="cs_image_url<?php echo cs_allow_special_char($rand_id); ?>_img" width="100" height="150" alt="" />
                        ...
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Caption', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                ...
                                <p><?php _e('If you would like a caption to be shown below the image, add it here', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <?php
                    ...
                    <?php if (isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode') { ?>
                        <ul class="form-elements insert-bg">
                            <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo cs_allow_special_char(str_replace('cs_pb_', '', $name)); ?>', '<?php echo cs_allow_special_char($name . $cs_counter) ?>', '<?php echo cs_allow_special_char($filter_element); ?>')" ><?php _e('Insert', 'Lawyer'); ?></a> </li>
                        </ul>
                        <div id="results-shortocde"></div>
                    <?php } else { ?>
                        <ul class="form-elements noborder">
    ...
    function cs_pb_promobox($die = 0) {
        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="promobox" data="<?php echo element_size_data_array_index($promobox_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_promobox {{attributes}}]{{content}}[/cs_promobox]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Promo box Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <?php
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                ...
                                <input name="cs_promo_image_url<?php echo esc_attr($cs_counter) ?>" type="button" class="uploadMedia left" value="<?php _e('Browse', 'Lawyer'); ?>"/>
                                <div class="left-info">

                                    <p><?php _e('Promo box Background image here', 'Lawyer'); ?></p>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Background Repeat', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select class="text_align" name="text_align[]">
                                    ...
                                    ?> value="left"><?php _e('Left', 'Lawyer'); ?></option>
                                    <option <?php
                                    if ($text_align == 'right') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="right"><?php _e('Right', 'Lawyer'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                <input type="text" name="cs_link_title[]" class="txtfield" value="<?php
                                echo cs_allow_special_char($cs_link_title);
                                ;
                                ?>" />
                            </li>
                        </ul>
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                ...
                                <p><?php _e('Give external/internal promo box link', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Button Background Color', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
    ...
    function cs_pb_slider($die = 0) {
        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="slider" data="<?php echo element_size_data_array_index($slider_element_size) ?>">
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_slider {{attributes}}]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Slider Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Slider Section Title', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <div class="input-sec">
                                ...
                                <div class="left-info">
                                    <p><?php _e('Please enter slider header title', 'Lawyer'); ?></p>
                                </div>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Choose Slider', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <div class="input-sec">
