        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="blog" data="<?php echo element_size_data_array_index($divider_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_divider {{attributes}}]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Divider Option', 'Lawyer'); ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Style', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select name="divider_style[]" class="dropdown" >
                                    <option <?php if ($divider_style == "crossy") echo "selected"; ?> value="crossy" ><?php _e('Cross', 'Lawyer'); ?></option>
                                    <option <?php if ($divider_style == "plain") echo "selected"; ?> value="plain" ><?php _e('Plain', 'Lawyer'); ?></option>
                                    <option <?php if ($divider_style == "zigzag") echo "selected"; ?> value="zigzag" ><?php _e('Zigzag', 'Lawyer'); ?></option>
                                    <option <?php if ($divider_style == "small-zigzag") echo "selected"; ?> value="small-zigzag" ><?php _e('Small Zigzag', 'Lawyer'); ?></option>
                                    <option <?php if ($divider_style == "3box") echo "selected"; ?> value="3box" ><?php _e('3 Box', 'Lawyer'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Back to Top', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select name="divider_backtotop[]" class="dropdown" >
                                    <option value="yes" <?php if ($divider_backtotop == "yes") echo "selected"; ?> ><?php _e('Yes', 'Lawyer'); ?></option>
                                    <option value="no" <?php if ($divider_backtotop == "no") echo "selected"; ?> ><?php _e('No', 'Lawyer'); ?></option>
                                </select>
                                <p><?php _e('set back to top from the dropdown', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                            ...
                            <li class="to-field">
                                ...
                                <p><?php _e('set margin top for the divider in px', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                            ...
                            <li class="to-field">
                                ...
                                <p><?php _e('set a margin bottom for the divider in px', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                            ...
                            <li class="to-field">
                                ...
                                <p><?php _e('set the divider height', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <?php
                    ...
                    <?php if (isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode') { ?>
                        <ul class="form-elements insert-bg">
                            <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo str_replace('cs_pb_', '', $name); ?>', '<?php echo esc_js($name . $cs_counter) ?>', '<?php echo esc_js($filter_element); ?>')" ><?php _e('Insert', 'Lawyer'); ?></a> </li>
                        </ul>
    ...
    function cs_pb_tooltip($die = 0) {
        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="tooltip" data="<?php echo element_size_data_array_index($tooltip_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_tooltip {{attributes}}]{{content}}[/cs_tooltip]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Tooltip Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Hover Title', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select name="tooltip_data_placement[]" class="dropdown" >
                                    <option <?php if ($tooltip_data_placement == "top") echo "selected"; ?> value="top" ><?php _e('Top', 'Lawyer'); ?></option>
                                    <option <?php if ($tooltip_data_placement == "left") echo "selected"; ?> value="left" ><?php _e('Left', 'Lawyer'); ?></option>
                                    <option <?php if ($tooltip_data_placement == "bottom") echo "selected"; ?> value="bottom" ><?php _e('Bottom', 'Lawyer'); ?></option>
                                    <option <?php if ($tooltip_data_placement == "right") echo "selected"; ?> value="right" ><?php _e('Right', 'Lawyer'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Content', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
    ...
    function cs_pb_flex_column($die = 0) {
        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="flex_column" data="<?php echo element_size_data_array_index($flex_column_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_column {{attributes}}]{{content}}[/cs_column]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Flex Column Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <?php
                        ...
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Column Text', 'Lawyer'); ?> </label>
                            </li>
                            <li class="to-field">
    ...
    function cs_pb_dropcap($die = 0) {
        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="blog" data="<?php echo element_size_data_array_index($dropcap_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_dropcap {{attributes}}]{{content}}[/cs_dropcap]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Drop cap Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <?php
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select name="dropcap_style[]">
                                    <option <?php if ($dropcap_style == "box") echo "selected"; ?> value="box" ><?php _e('Box', 'Lawyer'); ?></option>
                                    <option <?php if ($dropcap_style == "plain") echo "selected"; ?> value="plain" ><?php _e('Plain', 'Lawyer'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                ...
                                <p><?php _e('add your font size for the drop cap text', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Color', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                ...
                                <p><?php _e('Enter content here', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <?php
                        if (function_exists('cs_shortcode_custom_dynamic_classes')) {
    ...
    function cs_pb_highlight($die = 0) {
        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class); ?> <?php echo cs_allow_special_char($shortcode_view); ?>" item="highlight" data="<?php echo element_size_data_array_index($highlight_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo cs_allow_special_char($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>"  data-shortcode-template="[cs_highlight {{attributes}}]{{content}}[/cs_highlight]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Highlight Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <ul class="form-elements">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                ...
                                <p><?php _e('Enter the content', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <?php
                        if (function_exists('cs_shortcode_custom_dynamic_classes')) {
    ...
    function cs_pb_heading($die = 0) {
        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="heading" data="<?php echo element_size_data_array_index($heading_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>"  data-shortcode-template="[cs_heading {{attributes}}]{{content}}[/cs_heading]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Heading Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <?php
                        ...
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Color Title', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                ...
                                <p><?php _e('add font size number for the heading', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Align', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select class="dropdown" name="heading_align[]">
                                    ...
                                    ?>><?php _e('Left', 'Lawyer'); ?></option>
                                    <option  value="center" <?php
                                    if ($heading_align == 'center') {
                                        echo 'selected="selected"';
                                    }
                                    ?>><?php _e('Center', 'Lawyer'); ?></option>
                                    <option value="right" <?php
                                    if ($heading_align == 'right') {
                                        echo 'selected="selected"';
                                    }
                                    ?>><?php _e('Right', 'Lawyer'); ?></option>
                                </select>
                                <p><?php _e('Align the content position', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Divider On/Off', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select class="dropdown" name="heading_divider[]">
                                    ...
                                    ?>><?php _e('On', 'Lawyer'); ?></option>
                                    <option  value="off" <?php
                                    if ($heading_divider == 'off') {
                                        echo 'selected="selected"';
                                    }
                                    ?>><?php _e('Off', 'Lawyer'); ?></option>
                                </select>
                                <p><?php _e('set divider on/off for the list bottom border', 'Lawyer'); ?> </p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Font Style', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select class="dropdown" name="heading_font_style[]">
                                    <option value="normal" <?php
                                    if ($heading_font_style == 'normal') {
                                        echo 'selected="selected"';
                                    }
                                    ?>><?php _e('Normal', 'Lawyer'); ?></option>
                                    <option value="italic" <?php
                                    if ($heading_font_style == 'italic') {
                                        echo 'selected="selected"';
                                    }
                                    ?>><?php _e('Italic', 'Lawyer'); ?></option>
                                    <option value="oblique" <?php
                                    if ($heading_font_style == 'oblique') {
                                        echo 'selected="selected"';
                                    }
                                    ?>><?php _e('Oblique', 'Lawyer'); ?></option>
                                </select>
                                <p><?php _e('select a font style from the drop down', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Heading Color', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <input type="text" name="heading_color[]" class="bg_color"  value="<?php echo esc_attr($heading_color); ?>" />
                                <div class="left-info">
                                    <p><?php _e('heading color for the heading element', 'Lawyer'); ?></p>
                                </div>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Content Color', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <input type="text" name="heading_content_color[]" class="bg_color"  value="<?php echo esc_attr($heading_content_color); ?>" />
                                <div class="left-info">
                                    <p><?php _e('set a content color for the heading element', 'Lawyer'); ?></p>
                                </div>
                            </li>
                        </ul>
                        <ul class="form-elements">
...
if (!function_exists('cs_pb_list')) {
    ...
    function cs_pb_list($die = 0) {
        ...
        ?>
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="list" data="<?php echo element_size_data_array_index($list_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit List Style Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                    ...
                    <div class="cs-clone-append cs-pbwp-content" >
                        <div id="shortcode-item-<?php echo intval($cs_counter); ?>" data-shortcode-template="{{child_shortcode}} [/cs_list]" data-shortcode-child-template="[list_item {{attributes}}] {{content}} [/list_item]">
                            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true" data-template="[cs_list {{attributes}}]">
                                ...
                                <ul class="form-elements">
                                    <li class="to-label">
                                        <label><?php _e('List Stye', 'Lawyer'); ?></label>
                                    </li>
                                    <li class="to-field select-style">
                                        <select class="dropdown" id="cs_list_type_selected" name="cs_list_type[]" onchange="cs_toggle_list(this.value, 'cs_slider_height<?php echo esc_attr($name . $cs_counter) ?>')">
                                            <option value="none" <?php if ($cs_list_type == "none") echo "selected"; ?>><?php _e('None', 'Lawyer'); ?></option>
                                            <option value="icon" <?php if ($cs_list_type == "icon") echo "selected"; ?>><?php _e('Icon', 'Lawyer'); ?> </option>
                                            <option value="built" <?php if ($cs_list_type == "built") echo "selected"; ?>><?php _e('Bullet', 'Lawyer'); ?></option>
                                            <option value="decimal" <?php if ($cs_list_type == "decimal") echo "selected"; ?> ><?php _e('Decimal', 'Lawyer'); ?></option>
                                            <option value="alphabatic" <?php if ($cs_list_type == "alphabatic") echo "selected"; ?>><?php _e('Alphabetic', 'Lawyer'); ?> </option>
                                            <option value="numeric-icon" <?php if ($cs_list_type == "numeric-icon") echo "selected"; ?>><?php _e('Numeric and Icon', 'Lawyer'); ?> </option>
                                            <!-- <option value="custom_icon">Custom Icon</option>-->
                                        </select>
                                        <p><?php _e('set a list style from the dropdown', 'Lawyer'); ?></p>
                                    </li>
                                </ul>
                                <ul class="form-elements">
                                    <li class="to-label">
                                    ...
                                    <li class="to-field select-style">
                                        <select class="dropdown" name="cs_border[]">
                                            <option <?php if ($cs_border == "yes") echo "selected"; ?> value="yes"><?php _e('Yes', 'Lawyer'); ?></option>
                                            <option value="no" <?php if ($cs_border == "no") echo "selected"; ?>><?php _e('No', 'Lawyer'); ?></option>
                                        </select>
                                        <p><?php _e('set on/off for the list bottom border', 'Lawyer'); ?> </p>
                                    </li>
                                </ul>
                                <?php
                                if (function_exists('cs_shortcode_custom_dynamic_classes')) {
                            ...
                            if (isset($list_num) && $list_num <> '' && isset($atts_content) && is_array($atts_content)) {
                                foreach ($atts_content as $list_items) {
                                    ...
                                    <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo esc_attr($rand_id); ?>">
                                        <header>
                                            <h4><i class='icon-arrows'></i><?php _e('List Item(s)', 'Lawyer'); ?></h4>
                                            <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'Lawyer'); ?></a></header>
                                        <ul class='form-elements'>
                                            <li class='to-label'>
                                                <label><?php _e('List Item', 'Lawyer'); ?></label>
                                            </li>
                                            <li class='to-field'>
                                                <div class='input-sec'>
                        ...
                        <div class="wrapptabbox no-padding-lr">
                            <div class="opt-conts">
                                <ul class="form-elements">
                                    <li class="to-field"> <a href="#" class="add_servicesss cs-main-btn" onclick="cs_shortcode_element_ajax_call('list', 'shortcode-item-<?php echo esc_js($cs_counter); ?>', '<?php echo admin_url('admin-ajax.php'); ?>')"><i class="icon-plus-circle"></i><?php _e('Add List Item', 'Lawyer'); ?></a> </li>
                                    <div id="loading" class="shortcodeload"></div>
                                </ul>
                            </div>
                            <?php if (isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode') { ?>
                                <ul class="form-elements insert-bg noborder">
                                    <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo str_replace('cs_pb_', '', $name); ?>', 'shortcode-item-<?php echo esc_js($cs_counter); ?>', '<?php echo esc_js($filter_element); ?>')" ><?php _e('Insert', 'Lawyer'); ?></a> </li>
                                </ul>
                                <div id="results-shortocde"></div>
                            <?php } else { ?>
    ...
    function cs_pb_mesage($die = 0) {
        ...
        <div id="<?php echo cs_allow_special_char($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class); ?> <?php echo cs_allow_special_char($shortcode_view); ?>" item="mesage" data="<?php echo element_size_data_array_index($message_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter) ?> <?php echo cs_allow_special_char($shortcode_element); ?>" id="<?php echo cs_allow_special_char($name . $cs_counter) ?>" data-shortcode-template="[cs_message {{attributes}}]{{content}}[/cs_message]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Message Options', 'Lawyer'); ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
                        ...
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Message Type', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select id="cs_message_type<?php echo cs_allow_special_char($cs_counter) ?>" name="cs_message_type[]" onchange="cs_toggle_alerts(this.value,<?php echo cs_allow_special_char($cs_counter) ?>)">
                                    <option <?php if ($cs_message_type == "alert") echo "selected"; ?> value="alert" ><?php _e('Alert', 'Lawyer'); ?></option>
                                    <option <?php if ($cs_message_type == "message") echo "selected"; ?> value="message" ><?php _e('Message', 'Lawyer'); ?></option>
                                </select>
                                <p><?php _e('Select the display type for the Message', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements" id="cs_alerts_style<?php echo cs_allow_special_char($cs_counter) ?>" style="display:none">
                            <li class="to-label">
                                <label><?php _e('Message Style', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select name="cs_alert_style[]" id="cs_alert_style<?php echo cs_allow_special_char($cs_counter) ?>" onchange="cs_toggle_fancyalert(this.value,<?php echo cs_allow_special_char($cs_counter) ?>)">
                                    <option <?php if ($cs_alert_style == "normal_messagebox") echo "selected"; ?> value="normal_messagebox" ><?php _e('Normal', 'Lawyer'); ?></option>
                                    <option <?php //if($cs_alert_style=="threed_messagebox")echo "selected";   ?> selected  value="threed_messagebox" ><?php _e('3D Style', 'Lawyer'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class='form-elements' id="cs_infobox_<?php echo cs_allow_special_char($name . $cs_counter); ?>">
                            ...
                            <li class="to-field">
                                <?php cs_fontawsome_icons_box($cs_message_icon, $name . $cs_counter, 'cs_message_icon'); ?>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                        ...
                        <div id="fancy_active<?php echo intval($cs_counter) ?>">
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Button Text', 'Lawyer'); ?></label>
                                </li>
                                <li class="to-field">
                            ...
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Button Link', 'Lawyer'); ?></label>
                                </li>
                                <li class="to-field">
                            ...
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Message Box Title', 'Lawyer'); ?></label>
                                </li>
                                <li class="to-field">
                            ...
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Title Color', 'Lawyer'); ?></label>
                                </li>
                                <li class="to-field">
                        ...
                        <ul class="form-elements" id="cs_style_type<?php echo intval($cs_counter) ?>" style="display:none">
                            <li class="to-label">
                                <label><?php _e('Style Type', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select name="cs_style_type[]" >
                                    <option <?php if ($cs_style_type == "fancy") echo "selected"; ?> value="fancy" ><?php _e('Fancy', 'Lawyer'); ?></option>
                                    <option <?php if ($cs_style_type == "plain") echo "selected"; ?> value="plain" ><?php _e('Plain', 'Lawyer'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Close Button', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <div class="select-style">
                                    <select name="cs_message_close[]">
                                        <option <?php if ($cs_message_close == "yes") echo "selected"; ?> value="yes" ><?php _e('Yes', 'Lawyer'); ?></option>
                                        <option <?php if ($cs_message_close == "no") echo "selected"; ?> value="no" ><?php _e('No', 'Lawyer'); ?></option>
                                    </select>
                                    <p><?php _e('Set close button on/off', 'Lawyer'); ?></p>
                                </div>
                            </li>
                        </ul>
                        <ul class="form-elements">
...
if (!function_exists('cs_pb_testimonials')) {
    ...
    function cs_pb_testimonials($die = 0) {
        ...
        $defaults = array('column_size' => '1/1', 'testimonial_text_color' => '', 'cs_testimonial_text_align' => '', 'cs_testimonial_section_title' => '', 'cs_testimonial_class' => '', 'cs_testimonial_animation' => '', 'cs_testimonial_view' => '');
        if (isset($output['0']['atts']))
            $atts = $output['0']['atts'];
        else
            $atts = array();
        ...
        <div id="<?php echo cs_allow_special_char($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class); ?> <?php echo cs_allow_special_char($shortcode_view); ?>" item="testimonials" data="<?php echo element_size_data_array_index($testimonials_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter) ?> <?php echo cs_allow_special_char($shortcode_element); ?>" id="<?php echo cs_allow_special_char($name . $cs_counter) ?>" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Testimonials Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo cs_allow_special_char($name . $cs_counter) ?>','<?php echo cs_allow_special_char($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-clone-append cs-pbwp-content">
                    <div class="cs-wrapp-tab-box">
                                ...
                                <ul class="form-elements">
                                    ...
                                    <li class="to-field select-style">
                                        <select name="cs_testimonial_text_align[]" class="dropdown" >
                                            <option <?php if ($cs_testimonial_text_align == "left") echo "selected"; ?> ><?php _e('left', 'Lawyer'); ?></option>
                                            <option <?php if ($cs_testimonial_text_align == "right") echo "selected"; ?> ><?php _e('right', 'Lawyer'); ?></option>
                                            <option <?php if ($cs_testimonial_text_align == "center") echo "selected"; ?> ><?php _e('center', 'Lawyer'); ?></option>
                                        </select>
                                        <p> <?php _e('This will not apply in Slider View', 'Lawyer'); ?></p>
                                    </li>
                                </ul>
                                <ul class="form-elements">
                                    <li class="to-label">
                                    ...
                                    <li class="to-field select-style">
                                        <select name="cs_testimonial_view[]" class="dropdown" >
                                            <option <?php if ($cs_testimonial_view == "simple") echo "selected"; ?> ><?php _e('simple', 'Lawyer'); ?></option>    
                                            <option <?php if ($cs_testimonial_view == "slides") echo "selected"; ?> ><?php _e('slides', 'Lawyer'); ?></option>
                                        </select>
                                    </li>
                                </ul>
                                <ul class="form-elements">
                            ...
                            if (isset($testimonials_num) && $testimonials_num <> '' && isset($atts_content) && is_array($atts_content)) {
                                ...
                                foreach ($atts_content as $testimonials) {
                                    ...
                                    <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content'  id="cs_infobox_<?php echo cs_allow_special_char($rand_string); ?>">
                                        <header>
                                            <h4><i class='icon-arrows'></i><?php _e('Testimonial', 'Lawyer'); ?></h4>
                                            <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'Lawyer'); ?></a></header>
                                        <ul class='form-elements'>
                                            <li class='to-label'>
                                                <label><?php _e('Text', 'Lawyer'); ?></label>
                                        ...
                                        <ul class='form-elements'>
                                            <li class='to-label'>
                                                <label><?php _e('Author', 'Lawyer'); ?></label>
                                            </li>
                                            <li class='to-field'>
                                                <div class='input-sec'>
                                        ...
                                        <ul class='form-elements'>
                                            <li class='to-label'>
                                                <label><?php _e('Company', 'Lawyer'); ?></label>
                                            </li>
                                            <li class='to-field'>
                                                <div class='input-sec'>
                                                ...
                                                <div class='left-info'>
                                                    <p><?php _e('Company Name', 'Lawyer'); ?></p>
                                                </div>
                                            </li>
                                        </ul>
                                        <ul class="form-elements">
                                            ...
                                            <li class="to-field">
                                                ...
                                                <input name="testimonial_img<?php echo cs_allow_special_char($rand_string) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'Lawyer'); ?>"/>
                                            </li>
                                        </ul>
                                                ...
                                                <div class="dragareamain" style="padding-bottom:0px;">
                                                    <ul id="gal-sortable">
                                                        <li class="ui-state-default" id="">
                                                            <div class="thumb-secs"> <img src="<?php echo cs_allow_special_char($testimonial_img); ?>"  id="testimonial_img<?php echo cs_allow_special_char($rand_string) ?>_img" width="100" height="150" alt="" />
                        ...
                        <div class="wrapptabbox cs-pbwp-content" style="padding:0">
                            <div class="opt-conts">
                                <ul class="form-elements">
                                    <li class="to-field"> <a href="#" class="add_servicesss cs-main-btn" onclick="cs_shortcode_element_ajax_call('testimonials', 'shortcode-item-<?php echo cs_allow_special_char($cs_counter); ?>', '<?php echo admin_url('admin-ajax.php'); ?>')"><i class="icon-plus-circle"></i><?php _e('Add testimonials', 'Lawyer'); ?></a> </li>
                                    <div id="loading" class="shortcodeload"></div>
                                </ul>
                                <?php if (isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode') { ?>
                                    <ul class="form-elements insert-bg noborder">
                                        <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo str_replace('cs_pb_', '', $name); ?>', 'shortcode-item-<?php echo cs_allow_special_char($cs_counter); ?>', '<?php echo cs_allow_special_char($filter_element); ?>')" ><?php _e('Insert', 'Lawyer'); ?></a> </li>
                                    </ul>
                                    <div id="results-shortocde"></div>
                                <?php } else { ?>
                                    <ul class="form-elements noborder">
    ...
    function cs_pb_quote($die = 0) {
        ...
        <div id="<?php echo cs_allow_special_char($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class); ?> <?php echo cs_allow_special_char($shortcode_view); ?>" item="column" data="<?php echo element_size_data_array_index($quote_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo cs_allow_special_char($shortcode_element); ?>" id="<?php echo cs_allow_special_char($name . $cs_counter) ?>"  data-shortcode-template="[cs_quote {{attributes}}]{{content}}[/cs_quote]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Quote Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <div class="cs-pbwp-content cs-wrapp-tab-box">
                            ...
                            <ul class="form-elements">
                                ...
                                <li class="to-field">
                                    ...
                                    <p><?php _e('Give the name of the author', 'Lawyer'); ?></p>
                                </li>
                            </ul>
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Author Url', 'Lawyer'); ?></label>
                                </li>
                                <li class="to-field">
                                    <input type="text" name="quote_cite_url[]" class="txtfield" value="<?php echo esc_url($quote_cite_url); ?>" />
                                    <p><?php _e('Give the Author external&internal Url', 'Lawyer'); ?></p>
                                </li>
                            </ul>
                            <ul class="form-elements">
                                <li class="to-label">
                            ...
                            <ul class="form-elements">
                                ...
                                <li class="to-field select-style">
                                    <select name="quote_align[]" class="dropdown" >
                                        <option <?php if ($quote_align == "left") echo "selected"; ?> ><?php _e('left', 'Lawyer'); ?></option>
                                        <option <?php if ($quote_align == "right") echo "selected"; ?> ><?php _e('right', 'Lawyer'); ?></option>
                                        <option <?php if ($quote_align == "center") echo "selected"; ?> ><?php _e('center', 'Lawyer'); ?></option>
                                    </select>
                                    <p><?php _e('Align the content position', 'Lawyer'); ?></p>
                                </li>
                            </ul>
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Quote Content', 'Lawyer'); ?></label>
                                </li>
                                <li class="to-field">
...
if (!function_exists('cs_pb_contactus')) {
    ...
    function cs_pb_contactus($die = 0) {
        ...
        $defaults = array('cs_contactus_section_title' => '', 'cs_contactus_label' => '', 'form_left', 'cs_contactus_view' => '', 'cs_contactus_send' => '', 'cs_success' => '', 'cs_error' => '', 'cs_contact_class' => '', 'cs_contact_animation' => '');
        if (isset($output['0']['atts']))
            $atts = $output['0']['atts'];
        else
            $atts = array();
        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="contactus" data="<?php echo element_size_data_array_index($contactus_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_contactus {{attributes}}]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Contact Form Options', 'Lawyer'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter) ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="icon-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <?php
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select class="cs_contactus_view" id="cs_contactus_view" name="cs_contactus_view[]">
                                    <option <?php if ($cs_contactus_view == "plain") echo "selected"; ?> value="plain"><?php _e('Plain', 'Lawyer'); ?></option>
                                    <option <?php if ($cs_contactus_view == "fancy") echo "selected"; ?> value="fancy"><?php _e('Fancy', 'Lawyer'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Label On/Off', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select class="cs_contactus_label" id="cs_contactus_label" name="cs_contactus_label[]">
                                    <option <?php if ($cs_contactus_label == "on") echo "selected"; ?> value="on"><?php _e('On', 'Lawyer'); ?></option>
                                    <option <?php if ($cs_contactus_label == "off") echo "selected"; ?> value="off"><?php _e('Off', 'Lawyer'); ?></option>
                                </select>
                            </li>
                        </ul>
                        ...
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Send To', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <input type="text" name="cs_contactus_send[]" class="txtfield" value="<?php echo esc_attr($cs_contactus_send); ?>" />
                                <p><?php _e('add a email which you want to receive email', 'Lawyer'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Success Message', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <input type="text" name="cs_success[]" class="txtfield" value="<?php echo esc_attr($cs_success); ?>" />
                                <p><?php _e('Set a Message if your email sent successfully', 'Lawyer'); ?> </p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Error Message', 'Lawyer'); ?></label>
                            </li>
                            <li class="to-field">
                                <input type="text" name="cs_error[]" class="txtfield" value="<?php echo esc_attr($cs_error); ?>" />
                                <p><?php _e('set a message for error message', 'Lawyer'); ?></p>
                            </li>
                        </ul>
