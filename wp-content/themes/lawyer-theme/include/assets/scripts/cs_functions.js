...
function _delIcon(id){
	...
	jQuery(""+delId+ " .dp_icon").val('Choose Iccon');
...
var Data = [{
	"Class": "column_100",	"title": "100",	"element": ["time_line","case_process","gallery", "slider", "blog","event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "prayer", "advance_search", "parallax","table","call_to_action","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","post_team","casestudy","practice"]}, 
	{"Class": "column_75","title": "75",	"element": ["time_line","case_process","gallery", "slider", "blog", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box", "image_frame",'image', "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","post_team","casestudy","practice"]}, 
	{"Class": "column_67","title": "67","element": ["time_line","case_process","gallery", "slider", "blog", "event", "team", "column", "accordions", "team", "client", "contact", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "pointtable","table","flex_column","clients","spacer","heading","testimonials","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","post_team","casestudy","practice"]}, 
	{"Class": "column_50","title": "50","element": ["time_line","case_process","gallery", "slider", "blog", "event", "team", "column", "services", "accordions", "team", "client", "contact", "column", "divider", "message_box", "image_frame",'image', "map", "video", "quote", "dropcap", "pricetable", "services", "tabs", "accordion", "advance_search", "prayer","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","post_team","casestudy","practice"]},
...
function add_social_to_list(admin_url, theme_url) {
	...
	jQuery("#loading").html("<img src='" + theme_url + "/include/assets/images/ajax_loading.gif' alt=''/>");
	jQuery.ajax({
		type: "POST",
...
function add_education_to_list(admin_url, theme_url) {
	counter_education++;
	var dataString = 'counter_education=' + counter_education +
		'&directory_education_title=' + jQuery("#education_title").val() +
		'&directory_education_date=' + jQuery("#education_date").val() +
		'&directory_education_description=' + jQuery("#education_description").val() +
	...
	jQuery.ajax({
		...
		data: dataString,
		success: function(response) {
			jQuery("#total_educations").append(response);
			jQuery("#loading").html("");
			removeoverlay('add_education_title', 'append');
			jQuery("#education_title").val("Title");
			jQuery("#education_date").val("");
			jQuery("#education_description").val("");
		}
	});
	return false;
}

var counter_practice = 0;
function add_practice_to_list(admin_url, theme_url) {
	counter_practice++;
	var dataString = 'counter_practice=' + counter_practice +
		'&directory_practice_title=' + jQuery("#practice_title").val() +
		'&directory_practice_description=' + jQuery("#practice_description").val() +
		'&action=cs_add_practice_to_list';
	jQuery("#loading").html("<img src='" + theme_url + "/include/assets/images/ajax_loading.gif' alt=''/>");
	jQuery.ajax({
		type: "POST",
		url: admin_url,
		data: dataString,
		success: function(response) {
			jQuery("#total_practices").append(response);
			jQuery("#loading").html("");
			removeoverlay('add_practice_title', 'append');
			jQuery("#practice_title").val("Title");
			jQuery("#practice_description").val("");
		}
	});
	return false;
}
