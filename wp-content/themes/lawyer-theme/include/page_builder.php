...
function cs_page_options_add() {
    add_meta_box('id_page_options', __('CS Page Options', 'Lawyer'), 'cs_page_options', 'page', 'normal', 'high');
}

function cs_page_bulider_add() {
    add_meta_box('id_page_builder', __('CS Page Builder', 'Lawyer'), 'cs_page_bulider', 'page', 'normal', 'high');
}
...
function cs_page_bulider($post) {
    ...
    <div class="clear"></div>
    <div class="add-widget"> <span class="addwidget"> <a href="javascript:ajaxSubmit('cs_column_pb','1','column_full')"><i class="icon-plus-circle"></i><?php _e('Add Page Sections', 'Lawyer'); ?> </a> </span> 
        ...
        <div class="tabs vertical">
            <nav class="admin-navigtion">
                <ul id="myTab" class="nav nav-tabs">
                    <li class="active"><a href="#tab-general-settings" data-toggle="tab"><i class="icon-gear"></i><?php _e('General Settings', 'Lawyer'); ?> </a></li>
                    <li><a href="#tab-slideshow" data-toggle="tab"><i class="icon-forward2"></i><?php _e('Sub header', 'Lawyer'); ?></a></li>
    <?php if ($cs_builtin_seo_fields == 'on') { ?>
                        <li><a href="#tab-seo-advance-settings" data-toggle="tab"><i class="icon-globe6"></i><?php _e('Seo Options', 'Lawyer'); ?> </a></li>
    <?php } ?>
    <?php if ($cs_header_position == 'absolute') { ?>
                        <li><a href="#tab-header-position-settings" data-toggle="tab"><i class="icon-forward2"></i><?php _e('Header Absolute', 'Lawyer'); ?></a></li>
                    <?php } ?>
...
if (isset($_POST['page_builder_form']) and $_POST['page_builder_form'] == 1) {
    ...
    function save_page_builder($post_id) {
        ...
        if (isset($_POST['builder_active'])) {
            ...
            $counter_case_process = 0;
            $counter_case_process_node = 0;
            $counter_time_line_node = 0;
            $counter_time_line = 0;
            ...
            $cs_counter_case_process = 0;
            $cs_counter_time_line = 0;
            $cs_counter_apple = 0;
            ...
            $cs_global_counter_case_process = 0;
            $cs_global_counter_time_line = 0;
            $cs_shortcode_counter_richeditor = 0;
            $cs_shortcode_counter_case_process = 0;
            $cs_shortcode_counter_time_line = 0;
            ...
            $cs_global_counter_post_team = 0;
            $cs_shortcode_counter_post_team = 0;
            $cs_counter_post_team = 0;

            $cs_global_counter_casestudy = 0;
            $cs_shortcode_counter_casestudy = 0;
            $cs_counter_casestudy = 0;

            $cs_global_counter_practice = 0;
            $cs_shortcode_counter_practice = 0;
            $cs_counter_practice = 0;
                ...
                foreach ($_POST['total_column'] as $count_column) {
                    ...
                    for ($i = 0; $i < $count_column; $i++) {
                        ...
                        for ($j = 1; $j <= $a; $j++) {
                            ...
                            } else if ($_POST['cs_orderby'][$cs_counter] == "case_process") {
                                $shortcode = $shortcode_item = '';
                                $case_process = $column->addChild('case_process');
                                $case_process->addChild('page_element_size', htmlspecialchars($_POST['case_process_element_size'][$cs_global_counter_case_process]));
                                $case_process->addChild('case_process_element_size', htmlspecialchars($_POST['case_process_element_size'][$cs_global_counter_case_process]));

                                if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                    $shortcode_str = stripslashes($_POST['shortcode']['case_process'][$cs_shortcode_counter_case_process]);
                                    $cs_shortcode_counter_case_process++;
                                    $case_process->addChild('cs_shortcode', htmlspecialchars($shortcode_str, ENT_QUOTES));
                                } else {
                                    if (isset($_POST['case_process_num'][$counter_case_process]) && $_POST['case_process_num'][$counter_case_process] > 0) {
                                        for ($i = 1; $i <= $_POST['case_process_num'][$counter_case_process]; $i++) {
                                            $shortcode_item .= '[case_process_item ';
                                            if (isset($_POST['case_process_title'][$counter_case_process_node]) && $_POST['case_process_title'][$counter_case_process_node] != '') {
                                                $shortcode_item .= 'case_process_title="' . htmlspecialchars($_POST['case_process_title'][$counter_case_process_node], ENT_QUOTES) . '" ';
                                            }

                                            $shortcode_item .= ']';
                                            if (isset($_POST['case_process_text'][$counter_case_process_node]) && $_POST['case_process_text'][$counter_case_process_node] != '') {
                                                $shortcode_item .= htmlspecialchars($_POST['case_process_text'][$counter_case_process_node], ENT_QUOTES);
                                            }
                                            $shortcode_item .= '[/case_process_item]';

                                            $counter_case_process_node++;
                                        }
                                    }

                                    $section_title = '';
                                    if (isset($_POST['cs_case_process_section_title'][$counter_case_process]) && $_POST['cs_case_process_section_title'][$counter_case_process] != '') {
                                        $section_title = 'cs_case_process_section_title="' . htmlspecialchars($_POST['cs_case_process_section_title'][$counter_accordion], ENT_QUOTES) . '" ';
                                    }
                                    $shortcode = '[cs_case_process ' . $section_title;
                                    if (isset($_POST['cs_case_process_class'][$counter_case_process]) && $_POST['cs_case_process_class'][$counter_case_process] != '') {
                                        $shortcode .= ' cs_case_process_class="' . htmlspecialchars($_POST['cs_case_process_class'][$counter_case_process]) . '" ';
                                    }

                                    if (isset($_POST['cs_case_process_animation'][$counter_case_process]) && $_POST['cs_case_process_animation'][$counter_case_process] != '') {
                                        $shortcode .= ' cs_case_process_animation="' . htmlspecialchars($_POST['cs_case_process_animation'][$counter_case_process]) . '" ';
                                    }
                                    $shortcode .= ']' . $shortcode_item . '[/cs_case_process]';

                                    $case_process->addChild('cs_shortcode', $shortcode);
                                    $counter_case_process++;
                                }
                                $cs_global_counter_case_process++;
                            } else if ($_POST['cs_orderby'][$cs_counter] == "time_line") {
                                $shortcode = $shortcode_item = '';
                                $time_line = $column->addChild('time_line');
                                $time_line->addChild('page_element_size', htmlspecialchars($_POST['time_line_element_size'][$cs_global_counter_time_line]));
                                $time_line->addChild('time_line_element_size', htmlspecialchars($_POST['time_line_element_size'][$cs_global_counter_time_line]));

                                if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                    $shortcode_str = stripslashes($_POST['shortcode']['time_line'][$cs_shortcode_counter_time_line]);
                                    $cs_shortcode_counter_time_line++;
                                    $time_line->addChild('cs_shortcode', htmlspecialchars($shortcode_str, ENT_QUOTES));
                                } else {
                                    if (isset($_POST['time_line_num'][$counter_time_line]) && $_POST['time_line_num'][$counter_time_line] > 0) {
                                        for ($i = 1; $i <= $_POST['time_line_num'][$counter_time_line]; $i++) {
                                            $shortcode_item .= '[time_line_item ';
                                            if (isset($_POST['time_line_title'][$counter_time_line_node]) && $_POST['time_line_title'][$counter_time_line_node] != '') {
                                                $shortcode_item .= 'time_line_title="' . htmlspecialchars($_POST['time_line_title'][$counter_time_line_node], ENT_QUOTES) . '" ';
                                            }

                                            if (isset($_POST['time_line_readmore_link'][$counter_time_line_node]) && $_POST['time_line_readmore_link'][$counter_time_line_node] != '') {
                                                $shortcode_item .= 'time_line_readmore_link="' . htmlspecialchars($_POST['time_line_readmore_link'][$counter_time_line_node], ENT_QUOTES) . '" ';
                                            }

                                            $shortcode_item .= ']';
                                            if (isset($_POST['time_line_text'][$counter_time_line_node]) && $_POST['time_line_text'][$counter_time_line_node] != '') {
                                                $shortcode_item .= htmlspecialchars($_POST['time_line_text'][$counter_time_line_node], ENT_QUOTES);
                                            }
                                            $shortcode_item .= '[/time_line_item]';

                                            $counter_time_line_node++;
                                        }
                                    }

                                    $section_title = '';
                                    if (isset($_POST['cs_time_line_section_title'][$counter_time_line]) && $_POST['cs_time_line_section_title'][$counter_time_line] != '') {
                                        $section_title = 'cs_time_line_section_title="' . htmlspecialchars($_POST['cs_time_line_section_title'][$counter_accordion], ENT_QUOTES) . '" ';
                                    }
                                    $shortcode = '[cs_time_line ' . $section_title;
                                    if (isset($_POST['cs_time_line_class'][$counter_time_line]) && $_POST['cs_time_line_class'][$counter_time_line] != '') {
                                        $shortcode .= ' cs_time_line_class="' . htmlspecialchars($_POST['cs_time_line_class'][$counter_time_line]) . '" ';
                                    }

                                    if (isset($_POST['cs_time_line_animation'][$counter_time_line]) && $_POST['cs_time_line_animation'][$counter_time_line] != '') {
                                        $shortcode .= ' cs_time_line_animation="' . htmlspecialchars($_POST['cs_time_line_animation'][$counter_time_line]) . '" ';
                                    }
                                    $shortcode .= ']' . $shortcode_item . '[/cs_time_line]';

                                    $time_line->addChild('cs_shortcode', $shortcode);
                                    $counter_time_line++;
                                }
                                $cs_global_counter_time_line++;
                            ...
                            // Save testimonials page element 
                                ...
                                if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                    ...
                                    $shortcode = '[cs_testimonials  
                                                 ...
                                                 cs_testimonial_view="' . htmlspecialchars($_POST['cs_testimonial_view'][$cs_counter_testimonials]) . '"
                                    ...
                                    if (isset($_POST['tabs_num'][$counter_tabs]) && $_POST['tabs_num'][$counter_tabs] > 0) {
                                        for ($i = 1; $i <= $_POST['tabs_num'][$counter_tabs]; $i++) {
                                            ...
                                            if (isset($_POST['cs_tab_icon'][$counter_tabs_node]) && $_POST['cs_tab_icon'][$counter_tabs_node] != '') {
                                                $cs_tab_icon = $_POST['cs_tab_icon'][$counter_tabs_node];
                                                if (is_array($_POST['cs_tab_icon'][$counter_tabs_node]))
                                                    $cs_tab_icon = implode('', $_POST['cs_tab_icon'][$counter_tabs_node]);
                                                $shortcode_item .= 'cs_tab_icon="' . htmlspecialchars($cs_tab_icon, ENT_QUOTES) . '" ';
                                            }
                            ...
                            // post_team
                            else if ($_POST['cs_orderby'][$cs_counter] == "post_team") {
                                $shortcode = '';
                                $post_team = $column->addChild('post_team');
                                $post_team->addChild('page_element_size', htmlspecialchars($_POST['post_team_element_size'][$cs_global_counter_post_team]));
                                $post_team->addChild('post_team_element_size', htmlspecialchars($_POST['post_team_element_size'][$cs_global_counter_post_team]));
                                if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                    $shortcode_str = stripslashes($_POST['shortcode']['post_team'][$cs_shortcode_counter_post_team]);
                                    $cs_shortcode_counter_post_team++;
                                    $post_team->addChild('cs_shortcode', htmlspecialchars($shortcode_str));
                                } else {
                                    $shortcode = '[cs_post_team ';
                                    if (isset($_POST['cs_post_team_section_title'][$cs_counter_post_team]) && $_POST['cs_post_team_section_title'][$cs_counter_post_team] != '') {
                                        $shortcode .= 'cs_post_team_section_title="' . htmlspecialchars($_POST['cs_post_team_section_title'][$cs_counter_post_team], ENT_QUOTES) . '" ';
                                    }
                                    if (isset($_POST['cs_post_team_view'][$cs_counter_post_team]) && $_POST['cs_post_team_view'][$cs_counter_post_team] != '') {
                                        $shortcode .= 'cs_post_team_view="' . htmlspecialchars($_POST['cs_post_team_view'][$cs_counter_post_team]) . '" ';
                                    }if (isset($_POST['cs_post_team_num_post'][$cs_counter_post_team]) && $_POST['cs_post_team_num_post'][$cs_counter_post_team] != '') {
                                        $shortcode .= 'cs_post_team_num_post="' . htmlspecialchars($_POST['cs_post_team_num_post'][$cs_counter_post_team]) . '" ';
                                    }if (isset($_POST['cs_team_cat'][$cs_counter_post_team]) && $_POST['cs_team_cat'][$cs_counter_post_team] != '') {
                                        $shortcode .= 'cs_team_cat="' . htmlspecialchars($_POST['cs_team_cat'][$cs_counter_post_team]) . '" ';
                                    }if (isset($_POST['cs_post_team_orderby'][$cs_counter_post_team]) && $_POST['cs_post_team_orderby'][$cs_counter_post_team] != '') {
                                        $shortcode .= 'cs_post_team_orderby="' . htmlspecialchars($_POST['cs_post_team_orderby'][$cs_counter_post_team]) . '" ';
                                    }if (isset($_POST['post_team_pagination'][$cs_counter_post_team]) && $_POST['post_team_pagination'][$cs_counter_post_team] != '') {
                                        $shortcode .= 'post_team_pagination="' . htmlspecialchars($_POST['post_team_pagination'][$cs_counter_post_team]) . '" ';
                                    }if (isset($_POST['cs_post_team_class'][$cs_counter_post_team]) && $_POST['cs_post_team_class'][$cs_counter_post_team] != '') {
                                        $shortcode .= 'cs_post_team_class="' . htmlspecialchars($_POST['cs_post_team_class'][$cs_counter_post_team], ENT_QUOTES) . '" ';
                                    }if (isset($_POST['cs_post_team_animation'][$cs_counter_post_team]) && $_POST['cs_post_team_animation'][$cs_counter_post_team] != '') {
                                        $shortcode .= 'cs_post_team_animation="' . htmlspecialchars($_POST['cs_post_team_animation'][$cs_counter_post_team]) . '" ';
                                    }
                                    $shortcode .= ']';
                                    $post_team->addChild('cs_shortcode', $shortcode);
                                    $cs_counter_post_team++;
                                }
                                $cs_global_counter_post_team++;
                            }

                            // casestudy
                            else if ($_POST['cs_orderby'][$cs_counter] == "casestudy") {
                                $shortcode = '';
                                $casestudy = $column->addChild('casestudy');
                                $casestudy->addChild('page_element_size', htmlspecialchars($_POST['casestudy_element_size'][$cs_global_counter_casestudy]));
                                $casestudy->addChild('casestudy_element_size', htmlspecialchars($_POST['casestudy_element_size'][$cs_global_counter_casestudy]));
                                if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                    $shortcode_str = stripslashes($_POST['shortcode']['casestudy'][$cs_shortcode_counter_casestudy]);
                                    $cs_shortcode_counter_casestudy++;
                                    $casestudy->addChild('cs_shortcode', htmlspecialchars($shortcode_str));
                                } else {
                                    $shortcode = '[cs_casestudy ';
                                    if (isset($_POST['cs_casestudy_section_title'][$cs_counter_casestudy]) && $_POST['cs_casestudy_section_title'][$cs_counter_casestudy] != '') {
                                        $shortcode .= 'cs_casestudy_section_title="' . htmlspecialchars($_POST['cs_casestudy_section_title'][$cs_counter_casestudy], ENT_QUOTES) . '" ';
                                    }
                                    if (isset($_POST['cs_casestudy_cat'][$cs_counter_casestudy]) && $_POST['cs_casestudy_cat'][$cs_counter_casestudy] != '') {
                                        $shortcode .= 'cs_casestudy_cat="' . htmlspecialchars($_POST['cs_casestudy_cat'][$cs_counter_casestudy]) . '" ';
                                    }if (isset($_POST['cs_casestudy_num_post'][$cs_counter_casestudy]) && $_POST['cs_casestudy_num_post'][$cs_counter_casestudy] != '') {
                                        $shortcode .= 'cs_casestudy_num_post="' . htmlspecialchars($_POST['cs_casestudy_num_post'][$cs_counter_casestudy]) . '" ';
                                    }if (isset($_POST['cs_casestudy_orderby'][$cs_counter_casestudy]) && $_POST['cs_casestudy_orderby'][$cs_counter_casestudy] != '') {
                                        $shortcode .= 'cs_casestudy_orderby="' . htmlspecialchars($_POST['cs_casestudy_orderby'][$cs_counter_casestudy]) . '" ';
                                    }if (isset($_POST['cs_case_excerpt'][$cs_counter_casestudy]) && $_POST['cs_case_excerpt'][$cs_counter_casestudy] != '') {
                                        $shortcode .= 'cs_case_excerpt="' . htmlspecialchars($_POST['cs_case_excerpt'][$cs_counter_casestudy]) . '" ';
                                    }if (isset($_POST['casestudy_pagination'][$cs_counter_casestudy]) && $_POST['casestudy_pagination'][$cs_counter_casestudy] != '') {
                                        $shortcode .= 'casestudy_pagination="' . htmlspecialchars($_POST['casestudy_pagination'][$cs_counter_casestudy]) . '" ';
                                    }if (isset($_POST['cs_casestudy_class'][$cs_counter_casestudy]) && $_POST['cs_casestudy_class'][$cs_counter_casestudy] != '') {
                                        $shortcode .= 'cs_casestudy_class="' . htmlspecialchars($_POST['cs_casestudy_class'][$cs_counter_casestudy], ENT_QUOTES) . '" ';
                                    }if (isset($_POST['cs_casestudy_animation'][$cs_counter_casestudy]) && $_POST['cs_casestudy_animation'][$cs_counter_casestudy] != '') {
                                        $shortcode .= 'cs_casestudy_animation="' . htmlspecialchars($_POST['cs_casestudy_animation'][$cs_counter_casestudy]) . '" ';
                                    }
                                    $shortcode .= ']';
                                    $casestudy->addChild('cs_shortcode', $shortcode);
                                    $cs_counter_casestudy++;
                                }
                                $cs_global_counter_casestudy++;
                            }

                            // practice
                            else if ($_POST['cs_orderby'][$cs_counter] == "practice") {
                                $shortcode = '';
                                $practice = $column->addChild('practice');
                                $practice->addChild('page_element_size', htmlspecialchars($_POST['practice_element_size'][$cs_global_counter_practice]));
                                $practice->addChild('practice_element_size', htmlspecialchars($_POST['practice_element_size'][$cs_global_counter_practice]));
                                if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                    $shortcode_str = stripslashes($_POST['shortcode']['practice'][$cs_shortcode_counter_practice]);
                                    $cs_shortcode_counter_practice++;
                                    $practice->addChild('cs_shortcode', htmlspecialchars($shortcode_str));
                                } else {
                                    $shortcode = '[cs_practice ';
                                    if (isset($_POST['cs_practice_section_title'][$cs_counter_practice]) && $_POST['cs_practice_section_title'][$cs_counter_practice] != '') {
                                        $shortcode .= 'cs_practice_section_title="' . htmlspecialchars($_POST['cs_practice_section_title'][$cs_counter_practice], ENT_QUOTES) . '" ';
                                    }
                                    if (isset($_POST['cs_practice_view'][$cs_counter_practice]) && $_POST['cs_practice_view'][$cs_counter_practice] != '') {
                                        $shortcode .= 'cs_practice_view="' . htmlspecialchars($_POST['cs_practice_view'][$cs_counter_practice]) . '" ';
                                    }
                                    if (isset($_POST['cs_practice_cat'][$cs_counter_practice]) && $_POST['cs_practice_cat'][$cs_counter_practice] != '') {
                                        $shortcode .= 'cs_practice_cat="' . htmlspecialchars($_POST['cs_practice_cat'][$cs_counter_practice]) . '" ';
                                    }if (isset($_POST['cs_practice_num_post'][$cs_counter_practice]) && $_POST['cs_practice_num_post'][$cs_counter_practice] != '') {
                                        $shortcode .= 'cs_practice_num_post="' . htmlspecialchars($_POST['cs_practice_num_post'][$cs_counter_practice]) . '" ';
                                    }if (isset($_POST['cs_practice_orderby'][$cs_counter_practice]) && $_POST['cs_practice_orderby'][$cs_counter_practice] != '') {
                                        $shortcode .= 'cs_practice_orderby="' . htmlspecialchars($_POST['cs_practice_orderby'][$cs_counter_practice]) . '" ';
                                    }if (isset($_POST['practice_pagination'][$cs_counter_practice]) && $_POST['practice_pagination'][$cs_counter_practice] != '') {
                                        $shortcode .= 'practice_pagination="' . htmlspecialchars($_POST['practice_pagination'][$cs_counter_practice]) . '" ';
                                    }if (isset($_POST['cs_practice_class'][$cs_counter_practice]) && $_POST['cs_practice_class'][$cs_counter_practice] != '') {
                                        $shortcode .= 'cs_practice_class="' . htmlspecialchars($_POST['cs_practice_class'][$cs_counter_practice], ENT_QUOTES) . '" ';
                                    }if (isset($_POST['cs_practice_animation'][$cs_counter_practice]) && $_POST['cs_practice_animation'][$cs_counter_practice] != '') {
                                        $shortcode .= 'cs_practice_animation="' . htmlspecialchars($_POST['cs_practice_animation'][$cs_counter_practice]) . '" ';
                                    }
                                    $shortcode .= ']';
                                    $practice->addChild('cs_shortcode', $shortcode);
                                    $cs_counter_practice++;
                                }
                                $cs_global_counter_practice++;
                            }
