        ...
        foreach ($options as $value) {
            ...
            switch ($value['type']) {
                ...
                case 'textarea':
                    ...
                    if (isset($cs_theme_options)) {
                        $val = isset($cs_theme_options[$value['id']]) ? $cs_theme_options[$value['id']] : '';
                    }
                ...
                case 'gfont_select':
                    ...
                    $output .='<option value="default">' . __('Default Font', 'Lawyer') . '</option>';
                    $i = 0;
                    foreach ($value['options'] as $key => $option) {
                        $selected = '';
                        if ($select_value != '') {
                    ...
                    $output .='<ul class="form-elements" id="' . $value['id'] . '_select">
								<li class="to-label"><label>' . esc_attr($value['name']) . '<span>' . esc_attr($value['hint_text']) . '</span></label></li>
									...
									<div class="input-sec">
										<div class="select-style">
										<select name="' . $value['id'] . '" id="' . $value['id'] . '">
										<option value="">' . __('Select Attribute', 'Lawyer') . '</option>';
                    foreach ($value['options'] as $option) {
                        $selected = '';
                        if ($select_value != '') {
                            if ($select_value == $option) {
                ...
                case "upload":
                    ...
                    $output .= '<ul class="form-elements" id="' . $value['id'] . '_upload">
								  ...
								  <li class="to-field">
									...
									<input name="' . $value['id'] . '"  type="button" class="uploadMedia left" value="' . __('Browse', 'Lawyer') . '"/></label>
								  </li>
								</ul>';
                    //if($val <> ''){			
                ...
                case "upload font":
                    ...
                    $output .= '<ul class="form-elements" id="' . $value['id'] . '_upload">
								  ...
								  <li class="to-field">
									...
									<label class="browse-icon">
										<input name="' . $value['id'] . '" type="button" class="uploadMedia left" value="' . __('Browse', 'Lawyer') . '"/>
									</label>
								  </li>
								</ul>';
                ...
                case "upload favicon":
                    ...
                    $output .= '<label class="cs-browse"><input id="log" name="' . $value['id'] . '" type="button" class="uploadfile left" value="' . __('Browse', 'Lawyer') . '"/><i class="icon-upload"></i></label></div></li></ul>';
                ...
                case "sidebar":
                    ...
                    $output .= '<ul class="form-elements">
									...
									<li class="to-field">
										...
										<p>' . __('Please enter the desired title of sidebar', 'Lawyer') . '</p>
									</li>
								</ul>
								<div class="clear"></div>
								<div class="sidebar-area" style="display:' . $display . '">
									<div class="theme-help">
									  <h4 style="padding-bottom:0px;">' . __('Already Added Sidebars', 'Lawyer') . '</h4>
									  <div class="clear"></div>
									</div>
									<div class="boxes">
										...
										<thead>
											<tr>
												<th>' . __('Sider Bar Name', 'Lawyer') . '</th>
												<th class="centr">' . __('Actions', 'Lawyer') . '</th>
											</tr>
										</thead>
										<tbody id="sidebar_area">';
                    if ($display == 'block') {
                        $i = 1;
						if( is_array($val['sidebar']) ) { 
                ...
                case "networks":
                    ...
                    $output.='<ul class="form-elements">
								...
								<li class="to-field">
								  ...
								  <p>' . __('Please enter text for icon', 'Lawyer') . '</p>
								</li>
								<li class="full">&nbsp;</li>
								<li class="to-label">
								...
								<div class="input-sec">
								  ...
								  <label class="browse-icon"><input id="social_net_icon_path_input" name="social_net_icon_path_input" type="button" class="uploadMedia left" value="' . __('Browse', 'Lawyer') . '"/></label>
							   </li>
							  ...
							  <li class="to-label">
								<label>' . __('Icon Color', 'Lawyer') . '</label>
							  </li>
							  <li class="to-field">
								<div class="input-sec">
							  ...
							  <div class="theme-help">
								<h4 style="padding-bottom:0px;">' . __('Already Added Social Icons', 'Lawyer') . '</h4>
								<div class="clear"></div>
							  </div>
							  <div class="boxes">
							  <table class="to-table" border="0" cellspacing="0">
								  <thead>
									<tr>
									  <th>' . __('Icon Path', 'Lawyer') . '</th>
									  <th>' . __('Network Name', 'Lawyer') . '</th>
									  <th>' . __('Url', 'Lawyer') . '</th>
									  <th class="centr">' . __('Actions', 'Lawyer') . '</th>
									</tr>
								  </thead>
                    ...
                    $i = 0;
                    if (is_array($network_list) and $network_list  <> '') {
                        foreach ($network_list as $network) {
                            if (isset($network_list[$i]) || isset($network_list[$i])) {
                                ...
                                if (isset($network_list[$i]) and $network_list[$i] <> '') {
                                    $output .= '<i style="color:' . $social_font_awesome_color[$i] . ';" class="' . $network_list[$i] . ' fa-2x"></i>';
                                } else {
                                ...
                                $output.='<tr id="' . str_replace(' ', '-', $social_net_tooltip[$i]) . '" style="display:none">
													  ...
													  <li><a onclick="cs_toggle(\'' . str_replace(' ', '-', $social_net_tooltip[$i]) . '\')"><img src="' . get_template_directory_uri() . '/include/assets/images/close-red.png" /></a></li>
														  ...
														  <li class="to-field">
															...
															<label class="browse-icon"><input id="social_net_icon_path' . $i . '" name="social_net_icon_path' . $i . '" type="button" class="uploadMedia left" value="' . __('Browse', 'Lawyer') . '"/></label>
														  </li>
