        ...
        foreach ($tweets as $tweet) {
            ...
            if (isset($style)) {
                if (!empty($style)) {
                    ...
                    $twitter.='<div class="text"><a href="https://twitter.com/' . $id . '"><i class="icon-twitter2"></i>@' . $id . '</a><span> ' . $when;
...
function display_tweets_shortcode($id, $style = '', $max_tweets = 10, $max_cache_tweets = 10, $time = 60, $cs_tweets_color = '#000', $CustomId, $cs_tweets_class) {
    ...
    if (!empty($tweets)) {
        ...
        foreach ($tweets as $tweet) {
            ...
            $twitter .='<li class="" style="width: 100%; float: left; margin-right: -100%; position: relative; display: none;">
													<div class="text" style="color:' . $cs_tweets_color . '">';
    ...
    $html .= $twitter;
    $html.='<div class="follow-on"><div class="cs-tweet"><i class="fa fa-twitter"></i><a href="https://twitter.com/' . $id . '" target="_blank" style="color:">@' . $id . '</a></div></div>';
    $html .= '</ul></div></div>';
